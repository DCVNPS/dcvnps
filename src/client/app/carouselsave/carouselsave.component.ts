...
@Component({
  selector: 'app-carouselsave',
  templateUrl: './carouselsave.component.html',
  styleUrls: ['./carouselsave.component.scss']
})
export class CarouselsaveComponent implements OnInit, AfterContentInit {
