...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`dcvnps`@`%`*/ /*!50003 TRIGGER `bir_announcements` BEFORE INSERT ON `announcements` FOR EACH ROW BEGIN
