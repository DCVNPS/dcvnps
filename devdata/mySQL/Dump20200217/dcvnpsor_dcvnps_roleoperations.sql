...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`dcvnpsor_dcvnpsl`@`%`*/ /*!50003 TRIGGER `bir_roleoperations` BEFORE INSERT ON `roleoperations` FOR EACH ROW BEGIN
