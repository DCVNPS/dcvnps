...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`dcvnpsor_dcvnps`@`localhost`*/ /*!50003 TRIGGER `bir_users` BEFORE INSERT ON `users` FOR EACH ROW BEGIN
