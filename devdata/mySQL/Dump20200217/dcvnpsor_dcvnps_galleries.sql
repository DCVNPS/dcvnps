...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`dcvnpsor_dcvnps`@`localhost`*/ /*!50003 TRIGGER `bir_galleries` BEFORE INSERT ON `galleries` FOR EACH ROW BEGIN
