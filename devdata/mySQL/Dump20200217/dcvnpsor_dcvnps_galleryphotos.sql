...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`dcvnpsor_dcvnps`@`%`*/ /*!50003 TRIGGER `bir_galleryphotos` BEFORE INSERT ON `galleryphotos` FOR EACH ROW begin
